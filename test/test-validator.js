...
describe('validator', function() {
  ...
  describe('#isValidLabel()', function() {
    ...
    it('should return false if arg is unexpected character', function() {
      // without:
      //   00:                            09 0A       0D
      //   10:
      //   20:                                        2D 2E
  ...
  describe('#isValidValue()', function() {
    ...
    it('should return true if arg is valid value', function() {
      ...
      for (i = 0, len = expectedCharacters.length; i < len; ++i) {
        expect(validator.isValidValue(expectedCharacters[i])).to.be(true);
      }
    });
