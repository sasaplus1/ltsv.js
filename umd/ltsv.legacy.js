...
(function (global, factory) {
	...
	function objectToRecord(object, strict) {
	  ...
	  for (var i = 0, len = keys.length; i < len; ++i) {
	    ...
	    if (strict && !isValidLabel(label)) {
	      throw new SyntaxError("unexpected character of label: \"".concat(label, "\""));
	    }

	    if (strict && !isValidValue(value)) {
	      throw new SyntaxError("unexpected character of value: \"".concat(value, "\""));
	    }
	...
	function splitField(chunk, strict) {
	  ...
	  if (index === -1) {
	    throw new SyntaxError("field separator is not found: \"".concat(field, "\""));
	  }
	...
	function baseParseLine(line, strict) {
	  ...
	  for (var i = 0, len = fields.length; i < len; ++i) {
	    var _splitField = splitField(fields[i], strict),
...
//# sourceMappingURL=ltsv.legacy.js.map
